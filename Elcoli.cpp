...
int main() {
  ...
  Plataforma plataforma2(nullptr,sf::Vector2f(1000,5),sf::Vector2f(100,500) ); 
  ...
  while (window.isOpen()) {
    ...
    Collider colpalt1 = plataforma1.getCollider();
    
    player.getCollider().checkCollision(colpalt1,0.0f);
